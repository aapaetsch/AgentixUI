...
Enhanced navigation components with submenu support are available as premium components. These provide:
...
Premium navigation components will be available in the `@agentix/ui/premium` package:
