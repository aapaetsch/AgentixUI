 ...
 * For advanced features like circular/knobless handles, inset icons,
 * value indicators, stop indicators, and larger sizes (lg, xl),
 * see the Premium Slider component.
 *
 * ## Usage
 * ```tsx
 * // Basic
