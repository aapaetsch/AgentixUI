...
/**
 * Extended slider root variants that add lg and xl sizes.
 */
 ...
 *
 * Additional features beyond the basic slider API:
...
// Re-export basic slider primitives for compatibility.
export {
