...
import { PremiumSlider } from "./advanced";
 ...
 *
 * ## Base Slider Available
 * For the streamlined slider surface with xs, sm, and md sizes,
 * see the base slider story in this folder.
 *
 * ## Usage
 * ```tsx
 * // Basic
