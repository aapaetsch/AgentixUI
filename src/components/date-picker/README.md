...
The DatePicker is part of the `aapaetsch-ui-kit` package. Ensure you have the required dependencies:
...
```tsx
import { DatePicker } from "aapaetsch-ui-kit";
...
```tsx
import { DatePicker, DateRange } from "aapaetsch-ui-kit";
import { useState } from "react";
...
```tsx
import { DatePicker, getDatePresets } from "aapaetsch-ui-kit";
