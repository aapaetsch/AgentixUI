...
The TimePicker is part of the `aapaetsch-ui-kit` package. Ensure you have the required dependencies:
...
```tsx
import { TimePicker, TimeValue } from "aapaetsch-ui-kit";
...
```tsx
import { InlineTimePicker, TimeValue } from "aapaetsch-ui-kit";
import { useState } from "react";
